...
- **Trigger**: Configurable via `ASSISTANT_NAME` env var
- **Response prefix**: None (clean messages)
- **Persona**: Defined in `data/IDENTITY.md`
- **Main channel**: Private Matrix room (DM with yourself)
