...
> - Triggered only from WhatsApp (e.g., "@Assistant check my email" or "@Assistant send an email to...")
...
>
> `@Assistant check my recent emails`
>
> Or:
>
> `@Assistant list my Gmail labels`
...
> - Emails with a subject starting with a keyword (e.g., "[Assistant]")
...
Complete all Tool Mode steps above before continuing. Verify Gmail tools work by having the user test `@Assistant check my recent emails`.
